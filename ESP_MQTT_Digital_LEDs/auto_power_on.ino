...
const char* ssid = "1234"; //type your WIFI information inside the quotes
...
/**************************** FOR OTA **************************************************/
#define SENSORNAME "1234" //change this to whatever you want to call your device
#define OTApassword "1234" //the password you will need to enter to upload remotely via the ArduinoIDE
int OTAport = 8266;



/************* MQTT TOPICS (change these topics as you wish)  **************************/
const char* light_state_topic = "leds/onairtest";
const char* light_set_topic = "leds/onairtest/set";
...
void setup() {
  ...
  // set LEDs on at boot
  // comment out the next 2 lines if you don't want the LEDs to automatically turn on
  // when you connect them to power every time.
  Serial.println("Setting LEDs to a solid red color...");
  setColor(255, 0, 0);
